...
% Script to read in the raw ERP data downloaded from Te Whatu Ora
% populatiom web tool and save it as a wide-format table of population sizes by age
% and ethnicity
